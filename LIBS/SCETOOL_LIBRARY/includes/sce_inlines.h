...
static __inline void _es_sce_header(sce_header_t *h)
{
...
static __inline void _copy_es_sce_header(sce_header_t *dst, sce_header_t *src)
{
	memcpy(dst, src, sizeof(sce_header_t)); 
	_es_sce_header(dst);
}

static __inline void _es_metadata_header(metadata_header_t *h)
{
...
static __inline void _copy_es_metadata_header(metadata_header_t *dst, metadata_header_t *src)
{
	memcpy(dst, src, sizeof(metadata_header_t)); 
	_es_metadata_header(dst);
}

static __inline void _es_metadata_section_header(metadata_section_header_t *h)
{
...
static __inline void _copy_es_metadata_section_header(metadata_section_header_t *dst, metadata_section_header_t *src)
{
	memcpy(dst, src, sizeof(metadata_section_header_t)); 
	_es_metadata_section_header(dst);
}

static __inline void _es_self_header(self_header_t *h)
{
...
static __inline void _copy_es_self_header(self_header_t *dst, self_header_t *src)
{
	memcpy(dst, src, sizeof(self_header_t)); 
	_es_self_header(dst);
}

static __inline void _es_section_info(section_info_t *si)
{
...
static __inline void _copy_es_section_info(section_info_t *dst, section_info_t *src)
{
	memcpy(dst, src, sizeof(section_info_t)); 
	_es_section_info(dst);
}

static __inline void _es_sce_version(sce_version_t *sv)
{
...
static __inline void _copy_es_sce_version(sce_version_t *dst, sce_version_t *src)
{
	memcpy(dst, src, sizeof(sce_version_t)); 
	_es_sce_version(dst);
}

static __inline void _es_app_info(app_info_t *ai)
{
...
static __inline void _copy_es_app_info(app_info_t *dst, app_info_t *src)
{
	memcpy(dst, src, sizeof(app_info_t)); 
	_es_app_info(dst);
}

static __inline void _es_control_info(control_info_t *ci)
{
...
static __inline void _copy_es_control_info(control_info_t *dst, control_info_t *src)
{
	memcpy(dst, src, sizeof(control_info_t)); 
	_es_control_info(dst);
}

static __inline void _es_ci_data_digest_40(ci_data_digest_40_t *dig)
{
	dig->fw_version = _ES64(dig->fw_version);
}

static __inline void _copy_es_ci_data_digest_40(ci_data_digest_40_t *dst, ci_data_digest_40_t *src)
{
	memcpy(dst, src, sizeof(ci_data_digest_40_t)); 
	_es_ci_data_digest_40(dst);
}

static __inline void _es_ci_data_npdrm(ci_data_npdrm_t *np)
{
...
static __inline void _copy_es_ci_data_npdrm(ci_data_npdrm_t *dst, ci_data_npdrm_t *src)
{
	memcpy(dst, src, sizeof(ci_data_npdrm_t)); 
	_es_ci_data_npdrm(dst);
}

static __inline void _es_opt_header(opt_header_t *oh)
{
...
static __inline void _copy_es_opt_header(opt_header_t *dst, opt_header_t *src)
{
	memcpy(dst, src, sizeof(opt_header_t)); 
	_es_opt_header(dst);
}

static __inline void _es_oh_data_cap_flags(oh_data_cap_flags_t *cf)
{
...
static __inline void _copy_es_cap_flags(oh_data_cap_flags_t *dst, oh_data_cap_flags_t *src)
{
