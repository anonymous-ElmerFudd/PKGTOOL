...
static void __stdcall _print_spp_header(FILE *fp, spp_header_t *h)
{
...
static void __stdcall _print_spp_entry_header(FILE *fp, spp_entry_header_t *h, u32 idx)
{
...
void __stdcall spp_print(FILE *fp, sce_buffer_ctxt_t *ctxt)
{
	u32 i = 0;
	u8 *ent = NULL;
	...
	ent = ctxt->scebuffer + ctxt->metash[1].data_offset;
